...
class Brightness(nn.Module):
    ...
    def brightness(self, image):
        ...
        image[:, :, 2] = np.clip(image[:, :, 2] + self.coef, 0, 1)
    ...
    def forward(self, images):
        ...
        for idx in range(batch_size):
            image = images[idx]
            attacked_images[idx:idx + 1] = self.brightness(image)
...
noised_image = Brightness()(img_tensor)
print(noised_image.size())

save_image(noised_image, "../img_attacked/brightness_attacked/brightness_00000.png")